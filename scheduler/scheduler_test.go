...
func TestRoundRobinScheduleSelectCandidateNdoes(t *testing.T) {
...
func TestRoundRobinScheduleScoresCandidateNodes(t *testing.T) {
	tests := []struct {
		name       string
		lastWorker int
...
func TestRoundRobinSchedulerPickBestNode(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			rrs := RoundRobin{"test-rr-sceduler", 0}
